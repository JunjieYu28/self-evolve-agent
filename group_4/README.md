...
| 类型 | 链接 | 说明 |
|------|------|------|
| SFT 训练数据 | [Augety28/browsecomp-sft-data](https://huggingface.co/datasets/Augety28/browsecomp-sft-data) | BrowseComp SFT 训练集 (train.jsonl) |
| SFT 模型 | [Augety28/qwen35-9b-browsecomp-sft](https://huggingface.co/Augety28/qwen35-9b-browsecomp-sft) | Qwen3.5-9B BrowseComp SFT 微调模型 (merged) |
