...
IMAGE_UPLOADER      = os.getenv("IMAGE_UPLOADER", "tmpfiles")
...
def _direct_upload_local_image(path: Path) -> str:
    ...
    url = upload_path(path, backend=IMAGE_UPLOADER)
...
def search_image(
    ...
    in direct mode they are pushed to a public host (default tmpfiles.org).
    """
