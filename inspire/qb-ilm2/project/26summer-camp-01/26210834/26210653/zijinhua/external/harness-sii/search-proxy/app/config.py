...
class Settings:
    ...
    # Image upload backend when GPU sends a local file via /upload_image.
    # Supported: 0x0 | tmpfiles  (tmpfiles 需本机可访问外网，建议 source set_proxy.sh)
    image_uploader: str = os.getenv("IMAGE_UPLOADER", "tmpfiles")
